...
CREATE TABLE SVZ98608.SMSController(
   pkSMSController INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   type INT NOT NULL DEFAULT 1,
   number VARCHAR(255) NOT NULL,
   status INT NOT NULL DEFAULT 0,
   fkCountry SMALLINT NOT NULL,
...
CREATE TABLE SVZ98608.FinancialModule(
   pkFinancialModule INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   date VARCHAR(26) NOT NULL,
   wallet VARCHAR(255),
   status INT NOT NULL DEFAULT 0,
   fkMainBankAccount BIGINT NOT NULL,
...
CREATE TABLE SVZ98608.BillFinancialModuleFunction(
   pkBillFinancialModuleFunction INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE SVZ98608.CreditCardFinancialModuleFunction(
   pkCreditCardFinancialModuleFunction INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   status SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE SVZ98608.FinancialModuleTermsOfService(
   pkFinancialModuleTermsOfService INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   status SMALLINT NOT NULL DEFAULT 0,
   fkFinancialModule INT NOT NULL,
   fkAttachment BIGINT NOT NULL,
